      ...
      <div style={{
        ...
        <div style={{ flex: "1 1 350px", position: "relative", minHeight: "350px" }}>
          <img src={product.image} alt={product.name}
            ...
            onError={e => { e.target.src = "https://placehold.co/400x400?text=Jewellery"; }} />
          {!product.inStock && (
            <div style={{ position: "absolute", top: "16px", left: "16px", background: "#333", color: "#fff", padding: "6px 14px", borderRadius: "2px", fontSize: "11px", fontWeight: 700, letterSpacing: "1px" }}>
              OUT OF STOCK
            </div>
          )}
          {discount && product.inStock && (
            <div style={{ position: "absolute", top: "16px", left: "16px", background: "#7B2E3E", color: "#fff", padding: "6px 14px", borderRadius: "2px", fontSize: "11px", fontWeight: 700, letterSpacing: "1px" }}>
              -{discount}% OFF
            </div>
          )}
        </div>
        ...
        <div style={{ flex: "1 1 300px", padding: "40px 36px" }}>
          ...
          <div style={{ fontSize: "10px", color: "#C9963C", fontWeight: 700, letterSpacing: "3px", textTransform: "uppercase", marginBottom: "10px", fontFamily: "Josefin Sans, sans-serif" }}>{product.category}</div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "14px", marginBottom: "20px" }}>
            <span style={{ fontSize: "26px", fontWeight: 700, color: "#7B2E3E", fontFamily: "Josefin Sans, sans-serif" }}>₹{product.price.toLocaleString()}</span>
          ...
          {product.variants && product.variants.length > 0 && (
            <div style={{ marginBottom: "22px" }}>
              <p style={{ fontWeight: 600, marginBottom: "10px", fontSize: "12px", letterSpacing: "1.5px", textTransform: "uppercase", color: "#9a7a80", fontFamily: "Josefin Sans, sans-serif" }}>Select Finish</p>
              <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                {product.variants.map(v => (
                  <button key={v} onClick={() => setSelectedVariant(v)} style={{
                    padding: "7px 16px", borderRadius: "2px", fontSize: "12px", cursor: "pointer",
                    background: selectedVariant === v ? "#7B2E3E" : "#f5f0eb",
                    color: selectedVariant === v ? "#fff" : "#5a3a42",
                    border: selectedVariant === v ? "1.5px solid #7B2E3E" : "1.5px solid #e0d0d4",
                    fontWeight: selectedVariant === v ? 700 : 400,
                    transition: "all 0.2s",
          ...
          {product.material && (
            <div style={{ marginBottom: "12px", fontSize: "13px", color: "#7a5a60" }}>
              <strong>Material:</strong> {product.material}
            </div>
          )}

          {product.careInstructions && (
            <div style={{ marginBottom: "24px", fontSize: "13px", color: "#7a5a60", background: "#fdf8f5", padding: "14px", borderRadius: "6px", border: "1px solid #f0e4df" }}>
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            <button onClick={addToCart} disabled={!product.inStock} style={{
              flex: 1, padding: "15px", borderRadius: "2px", border: "none",
              cursor: product.inStock ? "pointer" : "not-allowed",
              background: product.inStock ? "#7B2E3E" : "#ccc",
            ...
            <button onClick={toggleWishlist} style={{
              ...
              border: "1.5px solid #7B2E3E",
              background: inWishlist ? "#7B2E3E" : "transparent",
              color: inWishlist ? "#fff" : "#7B2E3E",
              cursor: "pointer", fontSize: "18px",
              transition: "all 0.3s"
            }}>
              {inWishlist ? "❤️" : "🤍"}
  ...
  return (
    <nav className="navbar" style={scrolled ? { boxShadow: "0 2px 20px rgba(123,46,62,0.10)" } : {}}>
      ...
      <div className="nav-actions">
        ...
        <button className="nav-icon cart-btn" onClick={onCartOpen} title="Cart">
    ...
    <>
      ...
      >
        <div className="product-img-wrap">
          ...
          {!product.inStock && (
            <div className="sale-badge" style={{ background: "#555" }}>Out of Stock</div>
          )}
          {discount && product.inStock && (
          ...
          <div style={{
            ...
            fontSize: "10px", padding: "4px 9px", borderRadius: "10px",
            fontFamily: "Josefin Sans, sans-serif", letterSpacing: "0.5px"
          }}>
            👁 View
          </div>
        </div>
        <div className="product-info">
          ...
          {product.variants && (
            <div style={{ display: "flex", gap: "4px", flexWrap: "wrap", marginBottom: "10px" }}>
              {product.variants.slice(0, 3).map(v => (
                <span key={v} style={{
                  fontSize: "10px", background: "#f5f0eb",
                  padding: "2px 8px", borderRadius: "10px", color: "#9a7a80",
                  fontFamily: "Josefin Sans, sans-serif"
                }}>{v}</span>
              ))}
            </div>
          ...
          <button
            className={`btn-add-cart ${inCart ? "added" : ""} ${!product.inStock ? "disabled" : ""}`}
            onClick={addToCart}
      ...
      >
        ...
        <div className="hero-overlay">
          ...
          <p className="hero-desc">
            Handcrafted jewellery from the heart of Jaipur —<br />
    ...
    <div className="shop-page">
      ...
      <div className="shop-controls">
        ...
        <button
          ...
          style={{
            padding: "10px 18px", borderRadius: "2px", border: "none",
            cursor: "pointer", fontFamily: "Josefin Sans, sans-serif",
            background: showInStock ? "#7B2E3E" : "#f0ebe6",
            color: showInStock ? "#fff" : "#5a3a42",
            fontWeight: 600, fontSize: "11px", letterSpacing: "1.5px",
...
function Terms() {
  return (
    <div className="page-content">
      ...
      <div style={{ maxWidth: "1000px", margin: "40px auto", padding: "20px 40px", lineHeight: "1.8", color: "#6a4a50" }}>
        <h2 style={{ fontFamily: "Cormorant Garamond, serif", color: "#7B2E3E", marginBottom: "20px" }}>Terms &amp; Conditions</h2>
        <h3>1. General Information</h3>
        <p>Ray Fine Ornates is a Jaipur-based jewelry brand specializing in handcrafted jewelry made with precious, semi-precious, natural, and lab-created stones. All products are handcrafted and may have slight variations, making each piece unique.</p>
        <h3>2. Product Information</h3>
        <p>We make every effort to display product images, colors, materials, and descriptions accurately. However, slight differences may occur due to lighting, screen settings, photography, and the handmade nature of our jewelry.</p>
        ...
        <h3>4. Orders &amp; Payments</h3>
        <p>Orders are confirmed only after successful payment verification. Custom-made and personalized orders cannot be canceled once production has started.</p>
        <h3>5. Returns &amp; Exchanges</h3>
        <p>We accept returns or exchanges only according to our Return Policy. Customized, personalized, and worn items are generally non-returnable unless damaged or incorrect.</p>
        <hr style={{ margin: "40px 0", borderColor: "#f0e4df" }} />
        <h2 style={{ fontFamily: "Cormorant Garamond, serif", color: "#7B2E3E", marginBottom: "20px" }}>Refund &amp; Cancellation Policy</h2>
        <p>Orders may be canceled within 24 hours by contacting us at +91 8690666771.</p>
        <p><strong>Phone:</strong> +91 8690666771</p>
        <p>Ray Fine Ornates – Jaipur, Rajasthan, India</p>
